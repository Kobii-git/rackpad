...
- `RACKPAD_TAG=1.4.1` pins the Docker image to a known release. Git tags use
...
- `RACKPAD_TAG`: release version to run, for example `1.4.1`, or `latest` for
