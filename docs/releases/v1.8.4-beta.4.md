...
geometry. The standard repository gates and browser suite must pass before any
tag or publication; final command evidence is recorded with the release result.
