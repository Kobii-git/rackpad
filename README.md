...
- create version tags like `v1.4.1` from `main`
...
`RACKPAD_TAG=1.4.1` if you want this exact release, or `RACKPAD_TAG=beta` if
...
RACKPAD_TAG=1.4.1 bash /tmp/install-rackpad.sh
```
