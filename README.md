...
- create version tags like `v1.5.0` from `main`
...
`RACKPAD_TAG=1.5.0` if you want this exact release, or `RACKPAD_TAG=beta` if
...
RACKPAD_TAG=1.5.0 bash /tmp/install-rackpad.sh
```
